...
# This script is used to produce multiple crops of the labelized original wafer images (already in RGB channel)
# With the associated masks, to be used as training seg_tissues

# How to use
#  python gen_batches_wafer.py <dataset number> <'rgb' / 'grayscale'> <nb batches> <section size>
# Ex :  python gen_batches_wafer.py 1 rgb 60 512
